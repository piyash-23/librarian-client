      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-5xl bg-white shadow-xl rounded-3xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-blue-500 to-blue-700 p-10 text-white relative flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-bold mb-2 relative z-10">New Here?</h2>
            <p className="text-sm mb-8 opacity-90 relative z-10">
              Create an account to unlock premium tools, personalized features,
              and a new digital experience.
            </p>
            ...
            <button>
              <Link
                to={"/login"}
                className="btn shadow-none mt-3 bg-white text-blue-700 px-10 py-3 rounded-lg font-semibold hover:bg-gray-100 relative z-10 w-full"
              >
                Login
              </Link>
            </button>
            ...
            <form onSubmit={handleSubmit(handleRegister)} className="space-y-4">
              ...
              <div className="relative">
                ...
                <span
                  ...
                  className="absolute right-3 top-3 text-sm text-gray-900 cursor-pointer"
                >
